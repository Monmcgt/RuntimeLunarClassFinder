...
//        lunarMapping = this.javaClass.getResourceAsStream("/mappings/lunar.txt")?.bufferedReader()?.readLines() ?: throw Exception("Failed to read lunar.txt")
        ...
        mcpMapping = (this.javaClass.getResourceAsStream("/mappings/mcp.txt") ?: File("./file/mcp.txt").inputStream()).bufferedReader()
            .readLines()
            ?: throw Exception("Failed to read mcp.txt")
    }
...
//        val file = File("/home/USER/Downloads/Lunar Client Qt/Lunar Client Qt/mappings.txt")
